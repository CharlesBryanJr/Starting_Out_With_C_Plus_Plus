/*
Starting Out With C++ Chapter 9 Pointers – 12. Element Shifter
...
Element 0 of the argument array should be copied to element 1 of the new array, element 1 of the argument array should be copied to element 2 of the new array, and so forth. 
...
int main()
{
	...
	while(letter != 'n')
	{
        ...
        ElementShifter(ptr_array,sizeofarray,ele);

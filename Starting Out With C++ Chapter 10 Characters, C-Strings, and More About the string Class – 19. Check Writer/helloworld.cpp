/*
Starting Out With C++ Chapter 10 Characters, C-Strings, and More About the string Class – 19. Check Writer
Write a program that displays a simulated paycheck. 
The program should ask the user to enter the date, the payee’s name, and the amount of the check (up to $10,000). 
...
void PasswordVerifier(int &sizeOf_CstringArray)
{
...
bool IsDigit(const char * const ptr_CstringArray, const int &sizeOf_CstringArray, const int &ele)
{   
    if
    (
        *(ptr_CstringArray+ele) == '0' ||
        *(ptr_CstringArray+ele) == '1' ||
        *(ptr_CstringArray+ele) == '2' ||
        *(ptr_CstringArray+ele) == '3' ||
        *(ptr_CstringArray+ele) == '4' ||
        *(ptr_CstringArray+ele) == '5' ||
        *(ptr_CstringArray+ele) == '6' ||
        *(ptr_CstringArray+ele) == '7' ||
        *(ptr_CstringArray+ele) == '8' ||
        *(ptr_CstringArray+ele) == '9'
    )
    {
        return true;
    }
...
void DatePrinter(const int &sizeOf_CstringArray)
{
    std::cout << "----DatePrinter----" << "\n"; std::cout << " " << "\n";
    std::cout << "Write a program that reads a string from the user containing a date in the form mm/dd/yyyy." << "\n";
    std::cout << "It should print the date in the form March 12, 2014." << "\n"; 
    std::cout << "Press enter." << "\n";

    int sizeOf_DateArray{10};

    char *ptr_DateCstringArray{nullptr};
        ptr_DateCstringArray = new char[sizeOf_DateArray];

        for(int ele{0}; ele<sizeOf_DateArray; ++ele)
        {
            *(ptr_DateCstringArray+ele) = ' ';
        }

    std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
    std::cout << "User, input a date in the format of mm/dd/yyyy. : ";
        std::cin.getline(ptr_DateCstringArray,sizeOf_DateArray+1);

    //check format
    while
    (
        IsDigit(ptr_DateCstringArray,sizeOf_DateArray,0) == false ||
        IsDigit(ptr_DateCstringArray,sizeOf_DateArray,1) == false ||
        *(ptr_DateCstringArray+2) != '/' ||
        IsDigit(ptr_DateCstringArray,sizeOf_DateArray,3) == false ||
        IsDigit(ptr_DateCstringArray,sizeOf_DateArray,4) == false ||
        *(ptr_DateCstringArray+5) != '/' ||
        IsDigit(ptr_DateCstringArray,sizeOf_DateArray,6) == false ||
        IsDigit(ptr_DateCstringArray,sizeOf_DateArray,7) == false ||
        IsDigit(ptr_DateCstringArray,sizeOf_DateArray,8) == false ||
        IsDigit(ptr_DateCstringArray,sizeOf_DateArray,9) == false
    )
    {
        std::cout << "Input Validation: Incorrect date format." << "\n";
        std::cout << "Press enter." << "\n";

        std::cout << "User, input a date in the format of mm/dd/yyyy. : ";
            std::cin.getline(ptr_DateCstringArray,sizeOf_DateArray);
    }

    //print month
    if( *(ptr_DateCstringArray+0) == '0')
    {
        if( *(ptr_DateCstringArray+1) == '1') { std::cout << "January"; }
        if( *(ptr_DateCstringArray+1) == '2') { std::cout << "February"; }
        if( *(ptr_DateCstringArray+1) == '3') { std::cout << "March"; }
        if( *(ptr_DateCstringArray+1) == '4') { std::cout << "April"; }
        if( *(ptr_DateCstringArray+1) == '5') { std::cout << "May"; }
        if( *(ptr_DateCstringArray+1) == '6') { std::cout << "June"; }
        if( *(ptr_DateCstringArray+1) == '7') { std::cout << "July"; }
        if( *(ptr_DateCstringArray+1) == '8') { std::cout << "August"; }
        if( *(ptr_DateCstringArray+1) == '9') { std::cout << "September"; }
    }

    if( *(ptr_DateCstringArray+0) == '1')
    {
        if( *(ptr_DateCstringArray+1) == '0') { std::cout << "October"; }
        if( *(ptr_DateCstringArray+1) == '1') { std::cout << "Novemeber"; }
        if( *(ptr_DateCstringArray+1) == '2') { std::cout << "December"; }
    }

    //print space between month and date
    std::cout << " "; 

    //print day
    std::cout << *(ptr_DateCstringArray+3); 
    std::cout << *(ptr_DateCstringArray+4); 

    //print comma and space
    std::cout << ", "; 

    //print year
    std::cout << *(ptr_DateCstringArray+6); 
    std::cout << *(ptr_DateCstringArray+7); 
    std::cout << *(ptr_DateCstringArray+8); 
    std::cout << *(ptr_DateCstringArray+9); 

    delete[] ptr_DateCstringArray;
        ptr_DateCstringArray = nullptr;

    std::cout << " " << "\n";
}

void WordSeparator(char * const ptr_CstringArray, const int &sizeOf_CstringArray)
{
    std::cout << "----WordSeparator----" << "\n"; std::cout << " " << "\n";
    std::cout << "Write a program that accepts as input a sentence in which all of the words are run together, but the first character of each word is uppercase." << "\n";
    std::cout << "Convert the sentence to a string in which the words are separated by spaces and only the first word starts with an uppercase letter." << "\n"; 
    std::cout << "For example the string “StopAndSmellTheRoses.” would be converted to “Stop and smell the roses." << "\n"; std::cout << " " << "\n";

    //count uppercases
    int uppercasesCount{-1};
    int First_uppercases{-1};

    for(int ele{0}; ele<(sizeOf_CstringArray); ++ele)
    {
        if( *(ptr_CstringArray+ele) == toupper(*(ptr_CstringArray+ele)) )
        {   
            if( *(ptr_CstringArray+ele) != ' ' )
            {
                if( ele != 0 )
                {
                    ...
                    if (First_uppercases == -1 )
                    {
                        First_uppercases = ele;
                    }
                } 
            }
        }
    ...
    // create a new array, ptr_CstringArray_WordSeparator, and add one element for each uppercase found in ptr_CstringArray
    char *ptr_CstringArray_WordSeparator{nullptr};
        ptr_CstringArray_WordSeparator = new char[sizeOf_CstringArray+uppercasesCount];
    
    // input space char for each element of ptr_CstringArray_WordSeparator
    for(int ele{0}; ele<(sizeOf_CstringArray+uppercasesCount); ++ele)
    {
        *(ptr_CstringArray_WordSeparator+ele) = ' ';
    }
    
    for(int ele{0}; ele<(sizeOf_CstringArray); ++ele)
    {
        std::cout << "ele: " << ele << ", char: " << *(ptr_CstringArray+ele) << "\n";
    }
    ...
    for(int ele{0}; ele<sizeOf_CstringArray; ++ele)
    {
        if( ele >= First_uppercases )
        {
            // if uppercase
            if( *(ptr_CstringArray+ele) == toupper(*(ptr_CstringArray+ele)) )
            {
                // input a space char for the current element
                *(ptr_CstringArray_WordSeparator+ele+spaceCounter) = ' ';

                spaceCounter += 1;

                // lowercase the char and shift the element over one in the new array
                *(ptr_CstringArray_WordSeparator+ele+spaceCounter) = tolower(*(ptr_CstringArray+ele));
            }

            else // if lowercase
            {
                *(ptr_CstringArray_WordSeparator+ele+spaceCounter) = *(ptr_CstringArray+ele);
            }
        }

        else //  ele < First_uppercases
        {
            *(ptr_CstringArray_WordSeparator+ele) = *(ptr_CstringArray+ele);
        }
    ...
    for(int ele{0}; ele<(sizeOf_CstringArray+uppercasesCount); ++ele)
    {
        std::cout << "ele: " << ele << ", char: " << *(ptr_CstringArray_WordSeparator+ele) << "\n";
    }
    ...
    for(int ele{0}; ele<(sizeOf_CstringArray+uppercasesCount); ++ele)
    {
        std::cout << *(ptr_CstringArray_WordSeparator+ele);
    }

    delete ptr_CstringArray_WordSeparator;
        ptr_CstringArray_WordSeparator = nullptr;

    std::cout << " " << "\n";
}

void PigLatin(char * const ptr_CstringArray, const int &sizeOf_CstringArray)
{
    std::cout << "----PigLatin----" << "\n"; std::cout << " " << "\n";
    std::cout << "Write a program that reads a sentence as input and converts each word to “Pig Latin." << "\n";
    std::cout << "In one version, to convert a word to Pig Latin you remove the first letter and place that letter at the end of the word. ." << "\n"; 
    std::cout << "Then you append the string “ay” to the word." << "\n";
    std::cout << "English: I SLEPT MOST OF THE NIGHT" << "\n"; 
    std::cout << "IAY LEPTSAY OSTMAY FOAY HETAY IGHTNAY" << "\n"; std::cout << " " << "\n";
    ...
    int firstSpace{-1},
        lastCharIndex{-1},
        wordCounter{-1},
        wordCounter_subtractOne;

    std::cout << " " << "\n";

    for(unsigned int ele{0}; ele<sizeOf_CstringArray; ++ele)
    {
        if( *(ptr_CstringArray+ele) == ' ' )
        {
            ++wordCounter;
            if( *(ptr_CstringArray+ele+1) != ' ' && *(ptr_CstringArray+ele+1) != '\0' )
            {
                ++spaceCount;
                std::cout << "ele: " << ele << ", char: " << *(ptr_CstringArray+ele) << "\n";
            ...
            else if( *(ptr_CstringArray+ele+1) == ' ' && *(ptr_CstringArray+ele+1) != '\0')
            {
                if(lastCharIndex == -1)
                {
                    lastCharIndex = ele-2;
                    std::cout << "ele: " << lastCharIndex << ", lastChar: " << *(ptr_CstringArray+ele-2) << "\n";
                    wordCounter_subtractOne = wordCounter-1;
                    std::cout << "ele: " << wordCounter << "\n";
                    std::cout << "lastCharIndex-wordCounter: " << lastCharIndex-wordCounter << ", *(ptr_CstringArray+lastCharIndex-wordCounter): " << *(ptr_CstringArray+lastCharIndex-wordCounter) << "\n";
                    std::cout << "*(ptr_CstringArray+lastCharIndex-wordCounter): " << *(ptr_CstringArray+lastCharIndex-wordCounter) << "\n";
                }
    ...
    char *ptr_CstringArray_PigLatin{nullptr};
        ptr_CstringArray_PigLatin = new char[sizeOf_CstringArray+(2*spaceCount)];
    ...
    for(unsigned int index{0}; index<sizeOf_CstringArray; ++index)
    {
        if( index >= firstSpace )
        {
            ++wordCounter;

            // if orginal array index has a space and the orginal array index+1 is not a space
            if( *(ptr_CstringArray+index) == ' ' && *(ptr_CstringArray+index+1) != ' ' )
            {
                *(ptr_CstringArray_PigLatin+index+spaceCounter-wordCounter) = ' ';

                *(ptr_CstringArray_PigLatin+index+spaceCounter) = *(ptr_CstringArray+index-wordCounter);

                *(ptr_CstringArray_PigLatin+index+spaceCounter+1) = 'A';
                *(ptr_CstringArray_PigLatin+index+spaceCounter+2) = 'Y';
            ...
            else if( *(ptr_CstringArray+index) != ' ' )  
            {
                *(ptr_CstringArray_PigLatin+index+spaceCounter) = *(ptr_CstringArray+index); 
            }
            ...
            else // 
            {
                if( lastCharIndex != -1 )
                {
                    *(ptr_CstringArray_PigLatin+index+spaceCounter) = *(ptr_CstringArray+lastCharIndex-wordCounter_subtractOne);
                    *(ptr_CstringArray_PigLatin+index+spaceCounter+1) = 'A';
                    *(ptr_CstringArray_PigLatin+index+spaceCounter+2) = 'Y';
                    lastCharIndex = -1;
                }
        ...
        else // index < firstSpace 
        {
            // copy and input the char from orginal array to the new array at the same index as the orginal array
            *(ptr_CstringArray_PigLatin+index) = *(ptr_CstringArray+index);
        }
    }
    ...
    for(unsigned int index{0}; index<sizeOf_CstringArray; ++index)
    {
        if( index > firstSpace)
        {
            *(ptr_CstringArray_PigLatin+index-1) = *(ptr_CstringArray_PigLatin+index);
        }
    }
    ...
    for(int ele{0}; ele<(sizeOf_CstringArray); ++ele)
    {
        std::cout << "ele: " << ele << ", char: " << *(ptr_CstringArray_PigLatin+ele) << "\n";
    }
    ...
    for(int ele{0}; ele<(sizeOf_CstringArray); ++ele)
    {
        std::cout << *(ptr_CstringArray_PigLatin+ele);
    }

    delete[] ptr_CstringArray_PigLatin;
        ptr_CstringArray_PigLatin = nullptr;

    std::cout << " " << "\n";
}

void MorseCode(char * const ptr_CstringArray, const int &sizeOf_CstringArray)
{
    std::cout << "----MorseCode----" << "\n"; std::cout << " " << "\n";
    ...
    char *ptr_CstringArray_MorseCode{nullptr};
        ptr_CstringArray_MorseCode = new char[sizeOf_CstringArray];
    
    for(int ele{0}; ele<(sizeOf_CstringArray); ++ele)
    {
        *(ptr_CstringArray_MorseCode+ele) = ' ';
    }
    ...
    for(int ele{0}; ele<sizeOf_CstringArray; ++ele)
    {
        if(*(ptr_CstringArray+ele) == ' ') 
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = ' '; 
            shiftIndex += 1;
        }
        if(*(ptr_CstringArray+ele) == ',')
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-'; 
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-'; 
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.'; 
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+3) = '.'; 
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+4) = '-'; 
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+5) = '-'; 
            shiftIndex += 6;
        }
        if(*(ptr_CstringArray+ele) == '.')
        {
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'c' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'd' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'e' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            shiftIndex += 1;
        } 
        if( tolower(*(ptr_CstringArray+ele)) == 'f' ) 
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'g' ) 
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'h' ) 
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'i' ) 
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            shiftIndex += 2;
        } 
        if( tolower(*(ptr_CstringArray+ele)) == 'j' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'k' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'l' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'm' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            shiftIndex += 2;
        }  
        if( tolower(*(ptr_CstringArray+ele)) == 'n' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            shiftIndex += 2;
        } 
        if( tolower(*(ptr_CstringArray+ele)) == 'o' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'p' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'q' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'r' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 's' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 't' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            shiftIndex += 1;         
        }
        if( tolower(*(ptr_CstringArray+ele)) == 'u' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'v' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'w' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'x' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'y' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '.';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '-';
        ...
        if( tolower(*(ptr_CstringArray+ele)) == 'z' )
        {
            *(ptr_CstringArray_MorseCode+ele+shiftIndex) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+1) = '-';
            *(ptr_CstringArray_MorseCode+ele+shiftIndex+2) = '.';
    ...
    for(int ele{0}; ele<(sizeOf_CstringArray); ++ele)
    {
        if( *(ptr_CstringArray_MorseCode+ele) == '-')
        {
            if( *(ptr_CstringArray_MorseCode+ele+1) == '-')
            {
                if( *(ptr_CstringArray_MorseCode+ele+2) == '-')
                {
                    if( *(ptr_CstringArray_MorseCode+ele+3) == '-')
                    {
                        if( *(ptr_CstringArray_MorseCode+ele+4) == '-')
                        {
                            if( *(ptr_CstringArray_MorseCode+ele+5) == ' ')
                            {
                                if( *(ptr_CstringArray_MorseCode+ele+6) == ' ')
                                {
                                    *(ptr_CstringArray_MorseCode+ele) = ' ';
                                    *(ptr_CstringArray_MorseCode+ele+1) = ' ';
                                    *(ptr_CstringArray_MorseCode+ele+2) = ' ';
                                    *(ptr_CstringArray_MorseCode+ele+3) = ' ';
                                    *(ptr_CstringArray_MorseCode+ele+4) = ' ';
                                }
                            }
                        }
                    }
    ...
    for(int ele{0}; ele<(sizeOf_CstringArray); ++ele)
    {
        std::cout << "ele: " << ele << ", char: " << *(ptr_CstringArray_MorseCode+ele) << "\n";
    }
    ...
    for(int ele{0}; ele<(sizeOf_CstringArray); ++ele)
    {
        std::cout << *(ptr_CstringArray_MorseCode+ele);
    }

    delete[] ptr_CstringArray_MorseCode;
        ptr_CstringArray_MorseCode = nullptr;
}

void PhoneNumberList(std::string *StringArray, const int &sizeOf_StringArray)
{
    std::cout << "----PhoneNumberList----" << "\n"; std::cout << " " << "\n";

    for(int ele{0}; ele<sizeOf_StringArray; ++ele)
    {
        std::cout << "For entry " << ele << ", input the name and number : ";
        std::cin >> *(StringArray+ele);
    }

    std::string searchString;

    std::cout << "Input a name to search the number." << "\n";
    ...
    for(int ele{0}; ele<sizeOf_StringArray; ++ele)
    {
        if( searchString[ele] == ' ')
        {
            if(spaceFound == false)
            {
                firstName_count = ele-1;
                std::cout << "-------firstname_count : " << firstName_count << "\n";
            }
        }
        ...
        if( searchString[ele] == ',')
        {
            if(commaFound == false)
            {
                lastName_count = ele-1;
                std::cout << "-------firstname_count : " << lastName_count << "\n";
            }
        }
    }
    ...
    for(int ele{0}; ele<sizeOf_StringArray; ++ele)
    {
        if( searchString == *(StringArray+ele) )
        {
            std::cout << "Match found! : " << *(StringArray+ele);
            NoMatch = false;
            std::cout << " " << "\n";
        }
    }
    ...
    for(int ele{0}; ele<sizeOf_StringArray; ++ele)
    {
        std::cout << *(StringArray+ele);
    }

    std::cout << " " << "\n";
}

void CheckWriter(std::string *StringArray, const int &sizeOf_StringArray)
{
    std::cout << "----CheckWriter----" << "\n"; std::cout << " " << "\n";

    std::string dateOnChcek,
                payeeFirstName,
                payeeLastName,
                print_checkAmount;
    int checkAmount;
    
    std::cout << "User, enter the date : "; 
        std::cin >> dateOnChcek;

    std::cout << "User, enter the payee's first name : "; 
        std::cin >> payeeFirstName;

    std::cout << "User, enter the payee's last name : "; 
        std::cin >> payeeLastName;
    
    std::cout << "User, enter the amount of the check (up to 10,000) : "; 
        std::cin >> checkAmount;
    
    while ( checkAmount > 10000 )
    {
                            ...
                            if ( checkAmount > 7000 )
                            {
                                if ( checkAmount > 8000 )
                                {
                                    if ( checkAmount > 9000 )
                                    {
                                        if(checkAmount > 9900)
                                        {
                                            std::cout << "Nine thousand nine hundred and " << "\n";
                                        }
                                        else if( checkAmount > 9800 )
                                        {
                                            std::cout << "Nine thousand eight hundred and " << "\n";
                                        }
                                        else if( checkAmount > 9700 )
                                        {

                                        }
                                        else if( checkAmount > 9600 )
                                        {

                                        }
                                        else if( checkAmount > 9500 )
                                        {
    ...
    std::cout << std::setw(50) << "Date: " << dateOnChcek << "\n";
    std::cout << " " << "\n";
    std::cout << " " << "\n";
    std::cout << "Pay to the Order of: " << payeeFirstName << " " << payeeLastName << std::setw(10) << checkAmount << "\n";
...
int main()
{
    ...
    int sizeOf_StringArray{10};

    std::string *StringArray{nullptr};
        StringArray = new std::string[sizeOf_StringArray];
	...
	while(letter != 'n')
	{
        ...
        */
        ...
        {
            if(tolower(userChoice) == 'n') // Enter another string.
            {
                std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                    std::cout << "Press Enter." << "\n";
                std::cout << "User, input a string." << "\n";
            ...
            {
                DatePrinter(sizeOf_CstringArray);
            }
            ...
            if(tolower(userChoice) == 'm') 
            {
                MorseCode(ptr_CstringArray,sizeOf_CstringArray);
            }
            ...
            {
                PhoneNumberList(StringArray,sizeOf_StringArray);
            }
            if(tolower(userChoice) == 'r') 
            {
                replaceSubstring(ptr_CstringArray,ptr_intArray,sizeOf_CstringArray,ele);
            }
			if(tolower(userChoice) == 'q') 
            {
                PigLatin(ptr_CstringArray,sizeOf_CstringArray);
            }
            if( tolower(userChoice) == 't') 
            {
                CheckWriter(StringArray,sizeOf_StringArray);
            }
            if( tolower(userChoice) == 'v') 
            {
                reverse(ptr_CstringArray,sizeOf_CstringArray);
            }
            if( tolower(userChoice) == 'x') 
            {
                reverse(ptr_CstringArray,sizeOf_CstringArray);
            }
            if( tolower(userChoice) == 'w') 
            {
                WordSeparator(ptr_CstringArray,sizeOf_CstringArray);
            }

...
double annual_interest_rate{0.00}, starting_balance{0}, number_of_months{0}, balance{0}, month_deposit{0}, t_month_deposit{0}, month_withdraw{0}, t_month_withdraw{0}, monthly_interest{0}, t_intrest{0};
...
int main(){
    ...
    for(int month{0}; month<number_of_months; ++month){
        ...
        balance -= month_withdraw;

        monthly_interest = annual_interest_rate/12;
        t_intrest = monthly_interest*balance;
        balance = balance + monthly_interest*balance;
        
        std::cout << "\n";
    }

    std::cout << "Final balcance: " << balance << std::endl;

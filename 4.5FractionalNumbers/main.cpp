...
int main()
{
    ...
    //Scientific notation
    //What we have seen so far in terms of floating point types is fixed notation. 
    // There is another notation, scientificn that is handy if you have really huge numbers or small numbers to represent

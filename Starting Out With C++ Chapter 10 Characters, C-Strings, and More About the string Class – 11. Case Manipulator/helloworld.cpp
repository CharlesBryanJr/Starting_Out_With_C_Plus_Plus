/*
Starting Out With C++ Chapter 10 Characters, C-Strings, and More About the string Class 11. Case Manipulator
...
Like upper and lower, reverse should also accept a pointer to a string. 
As it steps through the string, it should test each character to determine whether it is upper- or lowercase. 
...
void replaceSubstring(char * const ptr_CstringArray, int * const ptr_intArray, const int &sizeOf_CstringArray, int &ele)
{
    ...
    OnOff = false;
    std::cout << "  detemine the length of the String : " << endOfCstringArray << "\n";
    std::cout << " " << "\n";
    ...
    OnOff = false;
    std::cout << "  detemine the length of the SubString to be found : " << endOfCstringArray2 << "\n";
    std::cout << " " << "\n";
    ...
    std::cout << "  detemine the length of the SubString to be replaced : " << endOfCstringArray3 << "\n";
    OnOff = false;

/*
Starting Out With C++ Chapter 9 Pointers – 10. Reverse Array
...
void ReverseArray(int * const ptr_array_mf, const int &sizeofarray, int &ele)
{
    ...
    for( ele=sizeofarray-1; ele>=0; --ele )
    {
        ...
        *(ptr_ReverseArray+reverse_ele) = *(ptr_array_mf+ele);
    }
    std::cout << " " << "\n";

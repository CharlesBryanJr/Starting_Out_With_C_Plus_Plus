...
The sideUp member variable will hold either “heads” or “tails” indicating the side of the coin that is facing up.
...
When the toss member function is called, it randomly determines the side of the coin that

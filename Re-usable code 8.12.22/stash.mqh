...
//+------------------------------------------------------------------+
double calculate_lotsize_by_percent(double percent_to_risk,double sl_pip_distance,string symbol="")
  {
      ...
      if(OrderMagicNumber()==magic_number)
        {
         ...
         if(OrderType()==OP_BUY)
           {
            sl_distance=(OrderOpenPrice()-OrderStopLoss())/grab_pip_value(OrderSymbol());
           }
         if(OrderType()==OP_SELL)
           {
            sl_distance=(OrderStopLoss()-OrderOpenPrice())/grab_pip_value(OrderSymbol());
           }

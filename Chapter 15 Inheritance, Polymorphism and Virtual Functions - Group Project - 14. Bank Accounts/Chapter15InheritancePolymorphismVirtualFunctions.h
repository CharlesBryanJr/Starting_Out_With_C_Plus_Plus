...
class BasicShape
{
	private: 
        ...
        // ***--- attributes or member variables ---***
            // What private data is the class responsible of storing
            double m_Area{0}; // area, a double used to hold the shape's area.
    ...
    public:
        ...
        // ***--- methods or member functions ---***
            ...
            // ***--- costructors ---***
	            // Useful for initializing private member variables or executing private member functions
	            BasicShape(){}; // default constructor 

                BasicShape( const double& Area ) 
                    : m_Area(Area)
                {} 
            ...
            // ***--- accessor or getter ---***
	            // Write public accessor functions that return the values in the member variables.
                double getArea() const // getArea. This function should return the value in the member variable area.
                    { return m_Area; }

            // ***--- mutator or setter  ---***
	            // Write public mutator functions to store values in the member variables.
	            // Update other member variables if needed. (return this;)
                virtual void calcArea(){} // calcArea. This function should be a pure virtual function.
			...
			// ***--- operator functions ---***
	            // redefine the way a particular operator works with an object
	            // Update other member variables if needed.		
				friend std::ostream& operator << (std::ostream& out, const BasicShape& basicShape);
...
class Circle : public BasicShape
{
	private: 
        ...
        // ***--- attributes or member variables ---***
            // What private data is the class responsible of storing
            long int m_CenterX{0};
            long int m_CenterY{0};
            double m_Radius{0};
    ...
    public:
        ...
        // ***--- methods or member functions ---***
            ...
            // ***--- mutator or setter  ---***
                ...
                {
                    BasicShape::setArea(3.14159 * m_Radius * m_Radius);
                }
    ...
    public:
        ...
        // ***--- methods or member functions ---***
            ...
            // ***--- mutator or setter  ---***
                ...
                virtual void calcArea()
                {
                    BasicShape::setArea( m_Length * m_Width );
                }
...
class BankAccount
{
	private: 
        ...
        // ***--- attributes or member variables ---***
            ...
            int m_NumberOfWithdraws{0};
            double m_AnnualIntrestRate{0};
            double m_MonthlyServiceCharges{0};
    ...
    public:
        ...
        // ***--- methods or member functions ---***
            ...
            // ***--- costructors ---***
                ...
                BankAccount( const double &Balance, const double &AnnualIntrestRate ) 
                    : m_Balance(Balance), m_AnnualIntrestRate(AnnualIntrestRate)
                {} 
            ...
            // ***--- accessor or getter ---***
                ...
                int getNumberOfDeposits() const 
                    { return m_NumberOfDeposits; }
                
                int getNumberOfWithdraws() const 
                    { return m_NumberOfWithdraws; }
                
                double getAnnualIntrestRate() const 
                    { return m_AnnualIntrestRate; }
                
                int getMonthlyServiceCharges() const 
                    { return m_MonthlyServiceCharges; }
            
            // ***--- mutator or setter  ---***
	            // Write public mutator functions to store values in the member variables.
	            // Update other member variables if needed. (return this;)
                virtual void deposit( const double &DepositAmount ) 
                    { m_Balance += DepositAmount; }

                virtual void withdraw( const double &WithdrawAmount );
                
                virtual void calculateIntrest();

                virtual void monthlyProcess();

                void incrementMonthlyServiceCharges()
                    { ++m_MonthlyServiceCharges; }
                
                void addMonthlyServiceCharges( const int& addAmount );
    ...
    public:
        ...
        // ***--- methods or member functions ---***
            ...
            // ***--- costructors ---***
                ...
                SavingAccount( const double &Balance, const double &AnnualIntrestRate) 
                    : BankAccount(Balance,AnnualIntrestRate)
                {
                    if( BankAccount::getBalance() > 25)
                    {
                        m_Status = true;
                    }
                    else // BankAccount::getBalance() < 25
                    {
                        m_Status = false;
                    }
                } 
			...
			// ***--- operator functions ---***
	            // redefine the way a particular operator works with an object
	            // Update other member variables if needed.		
				friend std::ostream& operator << (std::ostream& out, const SavingAccount& savingAccount);
    ...
    public:
        ...
        // ***--- methods or member functions ---***
            ...
            // ***--- costructors ---***
                ...
                CheckingAccount( const double &Balance, const double &AnnualIntrestRate ) 
                    : BankAccount(Balance,AnnualIntrestRate)
                {} 
			...
			// ***--- operator functions ---***
	            // redefine the way a particular operator works with an object
	            // Update other member variables if needed.		
				//friend std::ostream& operator << (std::ostream& out, const CheckingAccount& checkingAccount);
